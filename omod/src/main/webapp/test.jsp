...
<table id="target">
    ...
    <tr>
        <td>URI</td>
        <td><input id="url" type="text" value="${pageContext.request.contextPath}/ws/fhir/Patient/04dfbf7b-401c-4142-99fe-7d579c74a8e8" size="45"/></td>
    </tr>
    <tr>
        <td>Body content</td>
